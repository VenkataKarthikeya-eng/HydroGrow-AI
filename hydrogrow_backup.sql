...
\restrict IR5ypspaehajvrcYSfiAaDollwKRzF3CwvvMaYWGmgaMIOExIZcX2mkUebvXEDC
...
CREATE TABLE public.predictions (
    id integer NOT NULL,
    user_id integer NOT NULL,
    crop_type character varying NOT NULL,
    input_parameters json NOT NULL,
    predicted_weight double precision NOT NULL,
    growth_category character varying NOT NULL,
...
COPY public.predictions (id, user_id, crop_type, input_parameters, predicted_weight, growth_category, recommendations, explanation, created_at) FROM stdin;
\.
...
\unrestrict IR5ypspaehajvrcYSfiAaDollwKRzF3CwvvMaYWGmgaMIOExIZcX2mkUebvXEDC
